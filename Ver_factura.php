...
<div class="container">
	<div class="row justify-content-between">
      ...
      <div class="col-3">
        <a align="center" class="btn btn-primary" id="anchor_factura" onclick="factura_pdf()"><i class="far fa-save"></i></a>
      </div>  
    </div> 
</div> 	
<br><br>
...
function factura_pdf(){
	var anchor = document.getElementById('anchor_factura');
	var href = "http://tucasabonita.site/Ver_factura_descarga_pdf.php?compra_n=";
	var compra_n=<?php echo $compra_n;?>;
	var cedula=<?php echo $cedula;?>;
	compra_n=encodeURIComponent(window.btoa(compra_n));
	href=href+compra_n+"&cedula="+cedula;;
	location.href=href;
}
</script>
