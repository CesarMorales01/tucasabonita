...
<div class="container">
	<div class="row justify-content-center" >
      <div style="text-align: center;" class="col-3"  >
        <img  src="public_html/Imagenes_config/Logo_tucasabonita.png" width="140" height="200"> 
		</div>
	...
	<br>	
	<div class="row">
		<div class="row align-items-start col-lg-6 col-md-6 col-sm-12 col-12" >
			<div style="background-color:#f0e094;" class="col-lg-4 col-md-4 col-sm-4 col-4"  >
