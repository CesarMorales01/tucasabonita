...
$get_prest=$mysql->query("select * from prestamos where cedula=$cedula") or die ("problemas en la consulta");
...
$get_info_abonos=$mysql->query("select * from abonos where cedula=$cedula") or die($mysql->error);
$dates = [];
$altura_cuota=[];
$valor_abonos=[];
