...
echo '<form action="Rango_prestado_asesorx.php" method="post">';
...
if($fechas_duplicadas!=null){
	echo "<a href='prestado_rango_duplicados.php?fechas_duplicadas=".serialize($fechas_duplicadas)."'>Revisar registros duplicados!!!</a>"; 
}	
