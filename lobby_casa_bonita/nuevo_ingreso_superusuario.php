...
<br></br>    
<form method="post" action="Actualizar_caja_superusuario.php">
    ...
    <tr> 
        ...
        <td>
		<input type="text" name="Prestado" onChange="operacion_online()" size="7" id="Prestado" value="<?PHP echo number_format($Prestado_dia,2,",",".");?>">		 
        </td>
		
		<td>
		<input type="text" name="Gastos" onChange="operacion_online()" id="Gastos"  size="5" ">		 
        </td>
        ...
        <input type="text" name="Ingresos_netos" id="Ingresos_netos" size="5" ">   
         ...
         <td>
        <input type="text" name="Total_caja" size="7" id="Total_caja" value="<?PHP echo number_format($Total_caja1,2,",",".");?>">   
        </td>
