...
echo '</h1>';
echo '<br>';
echo '<a style="background-color:green; padding:8px;" href="Form_ingresar_prestamo_micro.php?cedula=';
        echo $cedula;
        echo '">';
...
$conexion= new mysqli($hostname_localhost,$username_localhost,$password_localhost,$database_localhost); 
    ...
    echo '<tr><th>Numero compra</th><th>Fecha</th><th>Total valor compra // Credito</th><th>Domicilio</th><th>Medio de pago</th><th>Comentarios</th><th>Cambio</th><th  data-toggle="tooltip" title="Diferente a entregada para que cargue la activity detalle credito en la app.">Estado</th></tr>';	
    $arrayEstado=[];
    $arrayIds=[];
    while ($items=$get->fetch_array()){   
    echo '<tr class="table-success" >';
    echo '<td>';
        echo '<a href="http://tucasabonita.ga/Detalle_compra_micro.php?cedula=';
        echo $cedula;
        echo '&compra_n=';
        echo  $items['compra_n'];
        echo '">';
    ...
    if($credito==""){
        ...
        echo '<a href="Form_%20detalle_cuentas_todos_micro.php?cedula=';
            echo $cedula;
            echo '">';
