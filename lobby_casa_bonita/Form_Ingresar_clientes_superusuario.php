...
<script>
  ...
  <div id="contenedor">  
  <form method="post" action="Registro_clientes_navegador_superusuario.php" id="form_registro_clientes">
  ...
  <input type="text" name="rifa" size="50"placeholder="Varios"> 
  <br> <br> 

  <input type="text" name="valor_letra" size="50" placeholder="Valor Letra"> 
  <br> <br> 
<?php 
