  ...
  $mysql = new mysqli("localhost", "u629086351_usuario", "pokemongo", "u629086351_ClientesMora");
	...
	if($cedula==$check){
			if($autor_registro==$check_autor_registro){
				...
				echo '<a href="Form_ detalle_cuentas_todos.php?cedula='.$_REQUEST['cedula'].'">Regresar</a>';
				echo '<br>';
				...
				echo '<form action="reportarCCM_historial.php" id"formReportar">';
				echo '<input type="hidden" name="cedula" value='.$cedula.'><br>';
				echo '<input type="hidden" name="fecha" value='.$fecha_prest.'><br>';
		...
		echo '<a href="Form_ detalle_cuentas_todos.php?cedula='.$_REQUEST['cedula'].'">Cancelar</a>';
		echo '<br>';
		echo '<form action="reportarCCM_historial.php">';
		echo '<input type="hidden" name="cedula" value='.$cedula.'><br>';
		echo '<input type="hidden" name="fecha" value='.$fecha_prest.'><br>';
