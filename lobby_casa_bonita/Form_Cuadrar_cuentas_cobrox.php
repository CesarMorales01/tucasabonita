...
$consultar_total_prestado=$mysql->query("SELECT sum(valorprestamo) as total_prestado_dia FROM prestamos where fecha_prest=$get_global_fecha_hoy and Cobro=$Cobro") or die ("problemas en consultar total prestado");
   ...
   $get_total_cobrado=$consultar_total_prestado->fetch_array();	  
	...
	// 2 FILA
     ...
     echo '<a href="Cuadrar_caja.php?Cobro='.$_REQUEST['Cobro'].'">Caja</a>';
     ...
     echo '<a href="Form_prestado_select_rango.php?Cobro='.$Cobro.'">Total prestado seleccionando rango</a>';
...
//1 FILA
	...
	echo '<tr>';
      ...
      echo '<a href="Form_lista_cobrado.php?cobro='.$_REQUEST['Cobro'].'">Lista cobrandoApp</a>';
     ...
     echo '</tr>'; 
      ...
      echo '</td>'; 
       ...
       echo '<tr>';
       echo '<td>';
       echo '<a href="Ver_lista_revisados.php?Cobro='.$_REQUEST['Cobro'].'">Ver lista revisados</a>';
       echo '</td>'; 
        echo '</tr>'; 
     echo '</table>';
     echo "<br>";
...
echo '<A Name="tema2"></a>';
 ...
 echo '<div style="display: flex; align-items: center; justify-content: center; width: 650px; margin: 0 auto;"  id="divTotales">'; 
     ...
     echo '<tr><th colspan="7"><a href="OpcionesTotales.php?Cobro='.$Cobro.'">TOTALES</a></th>';
     echo '<th> <a href="Guardar_totales_actual.php?Cobro='.$Cobro.'">Guardar totales actual</a> </th>';
     echo '</tr>';	
...
?>
<div class="container">
<canvas id="chart1"  width="600" height="100"></canvas>
</div> 
 <script>		
...
echo '<table class="tabencabezado" style="margin: 0 auto;">';
echo '<br><br>';
echo '<tr><th>PERIODO</th><th style="text-align:center;" >TOTAL CLIENTES</th><th style="text-align:center;"><a href="Clientes_con_prestamo.php?Cobro='.$Cobro.'">TOTAL PRESTAMOS</a></th style="text-align:center;" ><th style="text-align:center;"><a href="Clientes_sin_saldo.php?Cobro='.$Cobro.'">CLIENTES SIN SALDO</a></th></tr>';
echo '<tr>';
...
echo '</table>';
echo '</div>';	      
//<a href="Fechax_clientes_enmora.php?Cobro='.$Cobro.'&fecha='.$get_global_fecha_hoy_comis.'">Clientes en mora</a>
?>
 <!--Load the AJAX API-->
