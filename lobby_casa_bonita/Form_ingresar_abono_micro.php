...
<script>
  ...
  function inicio() {
    document.getElementById("Form_ingresar_abono_micro").addEventListener('submit', validar, false);
  }
...
<div id="contenedor"> 
  <form method="post" action="Ingresar_abono_web_micro.php" id="Form_ingresar_abono_micro"> 
Valor abono:
<br> 
...
Cuota numero:
 <br>
<input type="number" max="999" min="1" name="altura_cuota" placeholder="Cuota Numero" value="<?php
  echo $altura_cuota;
  ?>">
