...
echo '<form action="Rango_cobrado_asesorx_superusuario.php" method="post">';
...
if($fechas_duplicadas!=null){
	echo "<a href='cobrado_rango_duplicados_superusuario.php?fechas_duplicadas=".serialize($fechas_duplicadas)."'>Revisar registros duplicados!!!</a>"; 
}	
