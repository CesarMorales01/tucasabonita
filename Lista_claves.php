...
$get=$mysql->query("select * from crear_clave") or die ("problemas al consultar");
echo '<table class="table">';
echo '<tr><th>Nombre</th><th>Usuario</th><th>Cedula</th><th>E-mail</th><th>contraseña</th></tr>';	
while ($nombres=$get->fetch_array()){
echo '<tr class="table-success" >';
echo '<td>';
echo  $nombres['nombre'];
echo " ";
echo  $nombres['usuario'];
echo '</td>';
echo '<td>';
echo  $nombres['cedula'];
echo '</td>';
